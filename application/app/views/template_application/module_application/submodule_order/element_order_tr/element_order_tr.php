...
<?php foreach($data['data'] as $item):?>
    <tr data-show="true" data-type="order" class="show">
        ...
        <?php endif;?>
        <td class="text-center" style="border: 1px solid #dee2e6;"><a style="color: #dc3545; font-size: 1.3em" target="_blank" href="<?php echo '/public/pdf/orders/'.$item['n_code_ord'].'_'.$item['n_order_ne'].'.pdf';?>"><i class="fas fa-file-pdf"></i></a><input type="text" value="<?php echo $item['order_id'];?>" hidden></td>
