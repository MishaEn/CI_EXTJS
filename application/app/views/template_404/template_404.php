...
<body>
    ...
    <div class="terminal">
        ...
        <p class="output">Возможно, страница, которую вы ищете, была удалена, изменена или временно недоступна.</p>
        <p class="output">Пожауйста, попробуйте перейти <a href="/app">назад</a> или <a href="/login">авторизоваться</a>.</p>
        <p class="output">Удачи.</p>
    </div>
    <style>
